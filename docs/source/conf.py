...
latex_documents = [
    (master_doc, 'synthqc.tex', 'synthqc Documentation',
...
man_pages = [
    (master_doc, 'synthqc', 'synthqc Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'synthqc', 'synthqc Documentation',
     author, 'synthqc', 'One line description of project.',
     'Miscellaneous'),
]
